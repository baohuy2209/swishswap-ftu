...
import { BaggageClaim, ChevronRight, Home } from "lucide-react";
import Image from "next/image";
import { formatNumberVN } from "./components/listing-card";
...
function ListingDetails({ listingInfo, listMedia }: ListingDetailProps) {
        ...
        <div className="container mx-auto py-3 px-4">
          <div className="flex items-center gap-2 text-sm">
            ...
            <Link
              ...
              className="text-gray-600 hover:text-emerald-600 transition-colors flex items-center gap-1"
            >
              <BaggageClaim className="w-4 h04" />
              <span>Giao dịch</span>
            </Link>
            <ChevronRight className="w-4 h-4 text-gray-400" />
      ...
      <div className="container mx-auto py-10 px-4">
        <div className="flex flex-col md:flex-row gap-10">
          ...
          {mainImage?.images_url && (
            <div className="w-1/2 min-h-100 relative bg-white rounded-3xl shadow-xl">
              <Image
